...
export const sendEmail = async (to: string, subject: string, template: string, data: any) => {
    ...
    try {
        const mailOptions: CustomMailOptions = {
            ...
            to,
            subject,
            html: generateWelcomeMailBody(mailBody),
            // context: data,
        };
...
export function generateWelcomeMailBody(mailBodyData:any): string{
    const  {
        to,
        data
    } = mailBodyData
                                ...
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main"
                                    ...
                                    <tr>
                                        <td class="wrapper"
                                            ...
                                            <p
                                                style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                                                Sometimes you just want to send a simple HTML email with a simple design and clear
